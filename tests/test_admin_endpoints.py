...
def api_module(monkeypatch: pytest.MonkeyPatch):
    monkeypatch.setenv("LUMINA_RUNTIME_CONFIG_PATH", "model-packs/education-admin/cfg/runtime-config.yaml")
    ...
    mod.DOMAIN_REGISTRY = DomainRegistry(
        ...
        single_config_path="model-packs/education-admin/cfg/runtime-config.yaml",

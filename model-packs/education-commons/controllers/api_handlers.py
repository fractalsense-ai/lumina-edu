"""Domain-owned API route handlers for the education-commons pack.
...
log = logging.getLogger("lumina-api.education-commons")
...
async def post_vocabulary_metric(
    ...
    **_kw: Any,
    ...
    profile_path = resolve_profile_path(user_id, "education-commons")
    try:
    ...
    **_kw: Any,
    ...
    for user_dir in profiles_dir.iterdir():
        if not user_dir.is_dir():
            continue
        edu_profile = user_dir / "education-commons.yaml"

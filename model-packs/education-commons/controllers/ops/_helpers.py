"""Shared guard, profile, and commitment helpers for education-commons ops.

These are *private* to the education-commons domain-pack — not intended for
...
log = logging.getLogger("lumina.education-commons-ops")
...
def extract_short_name(module_id: str) -> str:
    ...
    ``domain/educom/student-commons/v1`` → ``student-commons``
    """
...
def list_learning_modules(ctx: Any, domain: str = "education-commons") -> list[dict[str, Any]]:
...
def resolve_module_shortname(
    ...
    Accepts full paths as pass-through (``domain/educom/student-commons/v1``

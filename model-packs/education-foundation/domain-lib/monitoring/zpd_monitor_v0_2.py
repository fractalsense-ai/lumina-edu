...
Conforms to (paths relative to repository root):
    model-packs/education-foundation/domain-lib/reference/zpd-monitor-spec-v1.md
    model-packs/education-foundation/domain-lib/reference/compressed-state-estimators.md
    model-packs/education-foundation/schemas/compressed-state-schema-v1.json
